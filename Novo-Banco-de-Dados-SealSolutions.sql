...
(null,'fazenda grind','R. Ype','jardim Pinheiros','SP','Monte Sião','Proximo da casa do Sr.João', 'Fazenda Grind produzindo felicidade'),
(null,'Jitterbiti Brasil','09111111','R. esmeralda','jardim olinda','MG','Ouro Verde','Predio Branco no final da rua' ,'Distribuidora de Frutos'),
(null,'P.R Tomates','09212233','R. Francisco das Neves','jardim Pamonha','GO','São bento','prédio', 'Produtora de tomates'),
(null,'Pomarola','0999888','R. verrelho','jardim Jandira','SP','São Paulina','prédio comercial','Distribuidora'),
(null,'Quero','09456789','R. lins fins','jardim Crispin','SP','jardins','Fazenda quero tomate', 'a Quero quer esta aqui para oferecer o melhor' ),
(null,'FarmLand','09789789','R.quintim','jardim Bom figliolio','SP','Santana de Vitoria','fazenda', 'Produtora de Tomates e Laranjas'),
(null,'Red-juicy','05789133','Travessa com Jardim pomar','Jardim Pomar','SC','Sorocaba','Proximo ao centro', 'Distribuidora de frutos e vegetais'),
(null,'TMM','02478321','R Mel Maria','Rosana','SP','São paulo','Predio vermelho', 'Produtora de Tomates, Morangos e Maças'),
(null,'Ver Monte','01389473','Estrada 29','Barra do mendez','BH','Seabra','Proxima a fazenda de vinhos', 'Produtora de tomates'),
(null,'Tamos Aqui','03294561','R. dos Senhores','Leme','PR','Pradaria do norte','Fica proximo a loja do Sr. Jose', 'Vendedora de tomates');
